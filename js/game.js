...
GeoBerdsk.Game = (function() {
    ...
    const MODES = {
        classic: {
            id: 'classic',
            name: 'Классический',
            description: '5 раундов · без лимита времени',
            rounds: 5,
            timeLimit: 0,
        },
        timeattack: {
            id: 'timeattack',
            name: 'На время',
            description: '5 раундов · 30 секунд каждый',
            rounds: 5,
            timeLimit: 30,
        },
        districts: {
            id: 'districts',
            name: 'Районы',
            description: 'Угадай микрорайон по панораме',
            rounds: 10,
            timeLimit: 0,
        },
        marathon: {
            id: 'marathon',
            name: 'Марафон',
            description: 'Играй, пока не промахнёшься',
            rounds: Infinity,
            timeLimit: 0,
        },
    };
